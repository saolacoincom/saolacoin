...
func (it *nodeIterator) Hash() meter.Bytes32 {
	if len(it.stack) == 0 {
...
func (it *nodeIterator) Parent() meter.Bytes32 {
	if len(it.stack) == 0 {
		return meter.Bytes32{}
	}
...
func (it *nodeIterator) nextChild(parent *nodeIteratorState, ancestor meter.Bytes32) (*nodeIteratorState, []byte, bool) {
...
func (it *differenceIterator) Hash() meter.Bytes32 {
	return it.b.Hash()
}

func (it *differenceIterator) Parent() meter.Bytes32 {
	return it.b.Parent()
}
...
func (it *differenceIterator) Next(bool) bool {
	...
	for {
		...
		case 0:
			...
			hasHash := it.a.Hash() == meter.Bytes32{}
...
func (it *unionIterator) Hash() meter.Bytes32 {
	return (*it.items)[0].Hash()
}

func (it *unionIterator) Parent() meter.Bytes32 {
...
func (it *unionIterator) Next(descend bool) bool {
	...
	for len(*it.items) > 0 && ((!descend && bytes.HasPrefix((*it.items)[0].Path(), least.Path())) || compareNodes(least, (*it.items)[0]) == 0) {
		...
		if skipped.Next(skipped.Hash() == meter.Bytes32{}) {
			it.count += 1
